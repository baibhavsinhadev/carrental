...
const Testimonial = () => {
    ...
    return (
        <div className="py-28 px-6 md:px-16 lg:px-24 xl:px-44">
            <userComponents.Title title="What Our Customers Say" subtitle="Discover why discerning travelers choose StayVenture for their luxury accommodations around the world." />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-18">
                {testimonials.map((testimonial, index) => (
                    <div key={index} className="bg-white p-6 rounded-xl shadow-lg hover:-translate-y-1 transition-all duration-500">
                        ...
                        <p className="text-gray-500 text-sm max-w-90 mt-4">
